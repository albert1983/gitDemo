...
(function (t) {
    ...
    t.cleanData = function (e) {
        ...
        t.position = {
            ...
            return v = s(_), _[0].preventDefault && (n.at = "left top"), p = v.width, f = v.height, m = v.offset, g = t.extend({}, m), t.each(["my", "at"], function () {
                ...
                var s, r, h = t(this), l = h.outerWidth(), u = h.outerHeight(), d = i(this, "marginLeft"), v = i(this, "marginTop"), k = l + d + i(this, "marginRight") + y.width, C = u + v + i(this, "marginBottom") + y.height, D = t.extend({}, g), T = e(x.my, h.outerWidth(), h.outerHeight());
                "right" === n.my[0] ? D.left -= l : "center" === n.my[0] && (D.left -= l / 2), "bottom" === n.my[1] ? D.top -= u : "center" === n.my[1] && (D.top -= u / 2), D.left += T[0], D.top += T[1], s = {
                    ...
                    var e = m.left - D.left, i = e + p - l, s = m.top - D.top, r = s + f - u, c = {
                        target: {
                            element: _,
                            left: m.left,
                            top: m.top,
    ...
    t.extend(s.prototype, {
        ...
        _generateHTML: function (t) {
            ...
            if (0 > Z && (Z += 12, te--), Q)for (e = this._daylightSavingAdjust(new Date(Q.getFullYear(), Q.getMonth() - V[0] * V[1] + 1, Q.getDate())), e = $ && $ > e ? $ : e; this._daylightSavingAdjust(new Date(te, Z, 1)) > e;)Z--, 0 > Z && (Z = 11, te--);
