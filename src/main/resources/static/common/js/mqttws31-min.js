...
Paho.MQTT = function (t) {
        ...
        for (var h = "", e, d = b; d < b + c;) {
            ...
            if (!(128 > e)) {
                ...
                if (224 > e) e = 64 * (e - 192) + p; else {
                    var s = a[d++] - 128;
                    if (0 > s) throw Error(f(g.MALFORMED_UTF, [e.toString(16), p.toString(16), s.toString(16)]));
                    if (240 > e) e = 4096 * (e - 224) + 64 * p + s; else {
                        var l = a[d++] - 128;
                        if (0 > l) throw Error(f(g.MALFORMED_UTF,
                            [e.toString(16), p.toString(16), s.toString(16), l.toString(16)]));
                        if (248 > e) e = 262144 * (e - 240) + 4096 * p + 64 * s + l; else throw Error(f(g.MALFORMED_UTF, [e.toString(16), p.toString(16), s.toString(16), l.toString(16)]));
                    }
                }
            }
    ...
    var z = function (a, b) {
        ...
        return c
    }, A = [0, 6, 77, 81, 73, 115, 100, 112, 3], B = [0, 4, 77, 81, 84, 84, 4], n = function (a, b) {
        this.type = a;
    ...
    n.prototype.encode = function () {
        ...
        if (3 == this.type) f = r(this.payloadMessage.destinationName, h, l, f); else if (1 == this.type) {
            ...
            l[f++] = a;
            f = x(this.keepAliveInterval, l, f)
        }
        void 0 != this.messageIdentifier && (f = x(this.messageIdentifier, l, f));
        switch (this.type) {
            case 1:
                f =
                    r(this.clientId, m(this.clientId), l, f);
                void 0 != this.willMessage && (f = r(this.willMessage.destinationName, m(this.willMessage.destinationName), l, f), f = x(e.byteLength, l, f), l.set(e, f), f += e.byteLength);
    ...
    var G = function (a, b, c) {
        ...
        if (!("WebSocket" in t && null !== t.WebSocket)) throw Error(f(g.UNSUPPORTED,
            ["WebSocket"]));
        if (!("localStorage" in t && null !== t.localStorage)) throw Error(f(g.UNSUPPORTED, ["localStorage"]));
        if (!("ArrayBuffer" in t && null !== t.ArrayBuffer)) throw Error(f(g.UNSUPPORTED, ["ArrayBuffer"]));
    ...
    k.prototype.subscribe = function (a, b) {
        ...
        b.timeout && (c.timeOut = new C(this, window, b.timeout, b.onFailure, [{
    ...
    k.prototype.startTrace = function () {
        ...
        this._trace("Client.startTrace", new Date, "1.0.1")
    };
    ...
    k.prototype._doConnect = function (a) {
        ...
        this.sendPinger = new G(this, window, this.connectOptions.keepAliveInterval);
        this.receivePinger = new G(this, window, this.connectOptions.keepAliveInterval);
        this._connectTimeout = new C(this, window, this.connectOptions.timeout, this._disconnected, [g.CONNECT_TIMEOUT.code, f(g.CONNECT_TIMEOUT)])
    };
    ...
    k.prototype._deframeMessages = function (a) {
        ...
        try {
            for (var b = 0, c = []; b < a.length;) {
                var h;
                a:{
                    var e = a, d = b, k = d, s = e[d], l = s >> 4, y = s & 15, d = d + 1, u = void 0, D = 0, m = 1;
                    do {
                        if (d == e.length) {
                            h = [null, k];
                            break a
                    ...
                    u = d + D;
                    if (u > e.length) h = [null, k]; else {
                        var v = new n(l);
                        switch (l) {
                            case 2:
                                e[d++] &
                                1 && (v.sessionPresent = !0);
                                v.returnCode = e[d++];
                                break;
                            case 3:
                                var k = y >> 1 & 3, r = 256 * e[d] + e[d + 1], d = d + 2, t = F(e, d, r), d = d + r;
                                0 < k && (v.messageIdentifier = 256 * e[d] + e[d + 1], d += 2);
                                var q = new Paho.MQTT.Message(e.subarray(d, u));
                                1 == (y & 1) && (q.retained = !0);
                                8 == (y & 8) && (q.duplicate = !0);
                                q.qos = k;
                                q.destinationName = t;
                            ...
                            case 7:
                            case 11:
                                v.messageIdentifier = 256 * e[d] + e[d + 1];
                                break;
                            case 9:
                                v.messageIdentifier = 256 * e[d] + e[d + 1], d += 2, v.returnCode = e.subarray(d, u)
                        }
                        h = [v, u]
                    }
                }
                var w = h[0], b = h[1];
                if (null !==
                    w) c.push(w); else break
            }
            b < a.length && (this.receiveBuffer = a.subarray(b))
        } catch (x) {
            this._disconnected(g.INTERNAL_ERROR.code, f(g.INTERNAL_ERROR, [x.message, x.stack.toString()]));
            return
        }
        return c
    };
            ...
            switch (a.type) {
                case 2:
                    ...
                    if (0 === a.returnCode) this.connected = !0, this.connectOptions.uris && (this.hostIndex = this.connectOptions.uris.length); else {
                        this._disconnected(g.CONNACK_RETURNCODE.code, f(g.CONNACK_RETURNCODE, [a.returnCode, I[a.returnCode]]));
                        break
                    }
                    a = [];
    ...
    var H = function (a, b, c, h) {
        ...
        this.connect = function (a) {
            ...
            if (a.willMessage) {
                if (!(a.willMessage instanceof w)) throw Error(f(g.INVALID_TYPE, [a.willMessage, "connectOptions.willMessage"]));
        ...
        this.unsubscribe = function (a, b) {
            if ("string" !== typeof a) throw Error("Invalid argument:" + a);
            b = b || {};
            z(b, {invocationContext: "object", onSuccess: "function", onFailure: "function", timeout: "number"});
