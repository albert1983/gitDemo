...
public class FastDFS {
    ...
    private static final String FAST_DFS_CONF_FILE = "properties/fastdfs-client.properties";
    ...
    public static byte[] downloadFile(String file_id) {  
        try {  
            long startTime = System.currentTimeMillis();  
            System.out.println("Download file[" + file_id + "] startTime::" + startTime);  
            ...
            byte[] localfileByteArr = sc.download_file1(file_id);
  
            System.out.println("Download file[" + file_id + "] ok");  
  
            long endTime = System.currentTimeMillis();  
            System.out.println("Download file[" + file_id + "] endTime::" + endTime);  
