...
public class ZipUtil {
     ...
     * @throws IOException
     */
    public void zip(String pathList, String destName) throws IOException {

        ZipOutputStream out = null;
        try {
            File outFile = new File(destFilePath + File.separator + destName);
    ...
    // 传输完毕后，删除服务器中己打包好的文件。避免空间占用太大
    public void deleteZipFile(String destName) throws IOException {

        File descFile = new File(destFilePath + File.separator + destName);
